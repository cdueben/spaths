...
<p style="text-align: justify">`spaths` also uses OpenMP in its non-`terra` distance computations. Because OpenMP is commonly not available on MacOS by default, the edge weight computations - like functions in a number of other R packages - tends to be faster on Windows and Linux than on MacOS.</p>
<br>
