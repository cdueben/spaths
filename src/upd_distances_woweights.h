...
void upd_dists_woweights(std::vector<std::vector<G> >& graph_to, Rcpp::List& coords, const std::vector<G>& starts, const std::vector<G>& targets,
  ...
  const std::vector<std::unordered_set<G> >& upd_rst, const bool show_progress, const int bar_limit, std::vector<D>& distances, const double radius2) {
