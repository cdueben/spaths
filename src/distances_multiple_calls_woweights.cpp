...
// void dists_multiple_calls_woweights
// void dists_multiple_calls_woweights
// void dists_multiple_calls_woweights
// void dists_multiple_calls_woweights
// void dists_multiple_calls_woweights
...
void dists_multiple_calls_woweights(const std::vector<std::vector<int> >& graph_to, const std::vector<int>& cell_numbers, const int ncol,
  ...
  std::vector<unsigned short int>& distances, const double radius2, const int starting_index, const int n_targets,
...
void dists_multiple_calls_woweights(const std::vector<std::vector<unsigned short int> >& graph_to, const std::vector<int>& cell_numbers,
  ...
  const std::vector<int>& affected_paths, std::vector<double>& distances, const double radius2, const int starting_index,
...
void dists_multiple_calls_woweights(const std::vector<std::vector<unsigned short int> >& graph_to, const std::vector<int>& cell_numbers, const int ncol,
  ...
  const bool early_stopping, const bool haversine, const std::unordered_set<unsigned short int>& upd_rst, const bool show_progress,
  const std::vector<int>& affected_paths, std::vector<float>& distances, const double radius2, const int starting_index,
  const int n_targets, const int begin_target) {
...
void dists_multiple_calls_woweights(const std::vector<std::vector<unsigned short int> >& graph_to, const std::vector<int>& cell_numbers,
  const int ncol, const double xres, const double yres, const double ymax, const unsigned short int start, const std::vector<unsigned short int>& targets,
  const bool early_stopping, const bool haversine, const std::unordered_set<unsigned short int>& upd_rst, const bool show_progress,
  const std::vector<int>& affected_paths, std::vector<int>& distances, const double radius2, const int starting_index,
  const int n_targets, const int begin_target) {
...
void dists_multiple_calls_woweights(const std::vector<std::vector<unsigned short int> >& graph_to, const std::vector<int>& cell_numbers, const int ncol,
  const double xres, const double yres, const double ymax, const unsigned short int start, const std::vector<unsigned short int>& targets,
  const bool early_stopping, const bool haversine, const std::unordered_set<unsigned short int>& upd_rst, const bool show_progress,
  const std::vector<int>& affected_paths, std::vector<unsigned short int>& distances, const double radius2, const int starting_index,
  const int n_targets, const int begin_target) {
...
void dists_multiple_calls_woweights(const std::vector<std::vector<unsigned short int> >& graph_to, const std::vector<int>& cell_numbers,
  const int ncol, const double xres, const double yres, const double ymax, const unsigned short int start, const std::vector<unsigned short int>& targets,
  const bool early_stopping, const bool haversine, const std::unordered_set<unsigned short int>& upd_rst, const bool show_progress,
  const std::vector<unsigned short int>& affected_paths, std::vector<double>& distances, const double radius2, const int starting_index,
  const int n_targets, const int begin_target) {
...
void dists_multiple_calls_woweights(const std::vector<std::vector<unsigned short int> >& graph_to, const std::vector<int>& cell_numbers, const int ncol,
  const double xres, const double yres, const double ymax, const unsigned short int start, const std::vector<unsigned short int>& targets,
  const bool early_stopping, const bool haversine, const std::unordered_set<unsigned short int>& upd_rst, const bool show_progress,
  const std::vector<unsigned short int>& affected_paths, std::vector<float>& distances, const double radius2, const int starting_index,
  const int n_targets, const int begin_target) {
...
void dists_multiple_calls_woweights(const std::vector<std::vector<unsigned short int> >& graph_to, const std::vector<int>& cell_numbers,
  const int ncol, const double xres, const double yres, const double ymax, const unsigned short int start, const std::vector<unsigned short int>& targets,
  const bool early_stopping, const bool haversine, const std::unordered_set<unsigned short int>& upd_rst, const bool show_progress,
  const std::vector<unsigned short int>& affected_paths, std::vector<int>& distances, const double radius2, const int starting_index,
  const int n_targets, const int begin_target) {
...
void dists_multiple_calls_woweights(const std::vector<std::vector<unsigned short int> >& graph_to, const std::vector<int>& cell_numbers, const int ncol,
  const double xres, const double yres, const double ymax, const unsigned short int start, const std::vector<unsigned short int>& targets,
  const bool early_stopping, const bool haversine, const std::unordered_set<unsigned short int>& upd_rst, const bool show_progress,
  const std::vector<unsigned short int>& affected_paths, std::vector<unsigned short int>& distances, const double radius2,
